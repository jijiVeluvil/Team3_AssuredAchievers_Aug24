...
Given admin create GET request  to check morbidity by "<sheet>" and "<row>" 
...
Given admin create POST request to check morbidity by "<sheet>" and "<row>"
When admin send http request with endpoint
Then admin recieves 405 method not allowed
Examples:
    | sheet       | row |
...
Given admin create GET request with invalid test name by "<sheet>" and "<row>"
When admin send http request with endpoint
Then admin recieves 404 not found
Examples: 
    | sheet   | row |
...
Given Dietician create GET request to check morbidity by "<sheet>" and "<row>" 
When Dietician sends GET HTTP request to morbidity endpoint
Then Dietician receives response code for morbidity request
Examples:
    | sheet       | row |
