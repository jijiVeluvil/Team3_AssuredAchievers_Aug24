...
//
//		apiFunction = new APIFunction(Tokens.TokenMap.get("AdminToken"), APIConstant.GET_ALL_MORBIDITY+"s",
//				APIConstant.GET);
//	}
//
...
//
//		apiFunction = new APIFunction(Tokens.TokenMap.get("dietBearerToken"), APIConstant.GET_ALL_MORBIDITY+"s",
//				APIConstant.GET);
//	}
//
...
//    	singleDataRow = DataHandler.getDataRow(sheet, row);
//     
//        apiFunction = new APIFunction(APIConstant.GET,Tokens.TokenMap.get("patBearerToken"),
